export class htmlAllProductsGetter {
    private sectionStart = `<section class="all"><div class="all_content">`;
    private sectionEnd = `</div></section>`;
    ...
    public getSStart () : string {
        return this.sectionStart;
    }
    public getSEnd () : string {
        return this.sectionEnd;
    }
    public getIndice () : string {
        return this.indice;
    }
    public getBArticle () : string {
        return this.basicArticle;
    }
    public getPArticle () : string {
